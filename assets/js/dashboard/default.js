...
var options = {
  series: [
    {
      name: "Aduan Masuk",
      data: [0, 15, 57, 61, 80, 50, 39],
    },
    {
      name: "Aduan Selesai",
      data: [1, 10, 69, 46, 66, 60, 15],
    },
    {
      name: "Target",
      // Garisan lurus 60 untuk semua 7 hari
  ...
  stroke: {
    // Lebar garisan: Aduan Masuk (4), Aduan Selesai (3), Target (2)
    width: [2, 4, 2], 
    curve: ["smooth", "smooth", "straight"], // Target dibuat 'straight' supaya tegak lurus
    dashArray: [8, 0, 5], // 5 bermaksud garisan target akan jadi putus-putus (optional)
  },
  // Tambah warna ketiga untuk Target (contoh: merah atau kelabu)
  colors: [EnzoAdminConfig.secondary, EnzoAdminConfig.primary, "#51bb25"], 
  markers: {
    size: 1,
  },
  xaxis: {
