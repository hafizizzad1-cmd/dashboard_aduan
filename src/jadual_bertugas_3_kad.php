...
// Bilangan staf untuk status Available
...
function dapatkanMasterListTarikh(
    $tarikh,
    $masterListMei,
    $masterListJun
){
    return ($tarikh < '2026-06-01')
        ? $masterListMei
        : $masterListJun;
}

function kiraJumlahOffice(
    $tarikh,
    $masterList,
    $rekodOOO,
    $backupStaff
){
    $status = dapatkanStatusHariIni(
        $tarikh,
        $masterList,
        $rekodOOO
    );
...
function formatTarikhRingkas($tarikh){
    $bulan = [
        1 => 'Jan',
        2 => 'Feb',
        3 => 'Mac',
    ...
    $objekTarikh = new DateTime($tarikh);

    return
        $objekTarikh->format('d')
        . ' '
        . $bulan[(int)$objekTarikh->format('n')]
        . ' '
        . $objekTarikh->format('Y');
}
...
$hariIniObjek = new DateTime('today');

// Jika hari ini Ahad, gunakan hari ini. Selain itu, cari Ahad terdekat.
$ahadIniObjek = clone $hariIniObjek;
if((int)$ahadIniObjek->format('N') !== 7){
    $ahadIniObjek->modify('next sunday');
}
$tarikhAhadIni = $ahadIniObjek->format('Y-m-d');

$esokObjek = clone $hariIniObjek;
$esokObjek->modify('+1 day');
$tarikhEsok = $esokObjek->format('Y-m-d');

$masterListEsok = dapatkanMasterListTarikh(
    $tarikhEsok,
    $masterListMei,
    $masterListJun
);

$statusEsok = dapatkanStatusHariIni(
    $tarikhEsok,
    $masterListEsok,
    $rekodOOO
);

$senaraiHadirEsok = $statusEsok['hadir'];

if(array_key_exists($tarikhEsok, $backupStaff)){
    $senaraiHadirEsok[] = $backupStaff[$tarikhEsok] . ' (Backup)';
}

$esokHariBekerja =
    (int)$esokObjek->format('N') < 6
    &&
    !array_key_exists($tarikhEsok, $senaraiCuti);

$jumlahHadirEsok = $esokHariBekerja
    ? count($senaraiHadirEsok)
    : 0;

if(!$esokHariBekerja){
    $teksHadirEsok = array_key_exists($tarikhEsok, $senaraiCuti)
        ? $senaraiCuti[$tarikhEsok]
        : 'Hujung minggu';
} elseif(count($senaraiHadirEsok) > 0){
    $teksHadirEsok = implode(', ', $senaraiHadirEsok);
} else {
    $teksHadirEsok = 'Tiada staf dijadualkan hadir';
}

// Cari hari Available dari hari ini hingga Jumaat minggu semasa.
$hariAvailableMingguIni = [];
$semakTarikhObjek = clone $hariIniObjek;

while((int)$semakTarikhObjek->format('N') <= 5){
    $tarikhSemak = $semakTarikhObjek->format('Y-m-d');

    if(!array_key_exists($tarikhSemak, $senaraiCuti)){
        $masterListSemak = dapatkanMasterListTarikh(
            $tarikhSemak,
            $masterListMei,
            $masterListJun
        );

        $jumlahOfficeSemak = kiraJumlahOffice(
            $tarikhSemak,
            $masterListSemak,
            $rekodOOO,
            $backupStaff
        ...
        if($jumlahOfficeSemak >= $availableThreshold){
            $hariAvailableMingguIni[] = [
                'tarikh' => $tarikhSemak,
                'jumlah' => $jumlahOfficeSemak
            ];
        }
    }

    $semakTarikhObjek->modify('+1 day');
}
...
<div class="container-fluid py-4 px-4">
    ...
    <!-- =====================================================
         KAD 1: BERTUGAS AHAD INI
         ===================================================== -->
    <div class="col-lg-4 col-md-6">

        <div class="top-summary-card card-duty">
            ...
            <div class="d-flex justify-content-between gap-3">
                ...
                <div>
                    ...
                    <div class="top-summary-date">

                        <?= formatTarikhRingkas($tarikhAhadIni) ?>

                    </div>

                    <div class="top-summary-main">

                        <?= htmlspecialchars(
                            $ahadDuty[$tarikhAhadIni]
                            ??
                            'Tiada'
                        ) ?>
    ...
    <!-- =====================================================
         KAD 2: HADIR OFIS ESOK
         ===================================================== -->
    <div class="col-lg-4 col-md-6">

        <div class="top-summary-card card-tomorrow">
            ...
            <div class="d-flex justify-content-between gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="top-summary-date">
                        ...
                        <?= formatTarikhRingkas($tarikhEsok) ?>
                    ...
                    <?php if(
                        $esokHariBekerja
                        &&
                        count($senaraiHadirEsok) > 0
                    ): ?>

                        <div class="top-summary-meta">

                            <?= $jumlahHadirEsok ?>
                            staf dijadualkan hadir

                        </div>

                        <div class="tomorrow-staff-list">
                    ...
                    <?php else: ?>
                        ...
                        <div class="staff-empty-note">

                            <iconify-icon
                                icon="mdi:calendar-remove-outline">
                            </iconify-icon>

                            <?= htmlspecialchars($teksHadirEsok) ?>
    ...
    <!-- =====================================================
            KAD 3: HARI BOLEH WFH
            ===================================================== -->
        <div class="col-lg-4 col-md-12">

            <div class="top-summary-card card-available">
                ...
                <div class="d-flex justify-content-between gap-3">
                    ...
                    <div>
                        ...
                        <div class="top-summary-date">
                            ...
                            Hari dengan sekurang-kurangnya
                            <?= $availableThreshold ?>
                            staf di pejabat
                        ...
                        <div class="top-summary-main">
                            ...
                            <?= count($hariAvailableMingguIni) ?>
                            hari

                        </div>

                        <div class="top-summary-detail">
                            ...
                            <?php if(
                                ...
                                <?php foreach(
                                    ...
                                    <span class="available-chip">
                                        ...
                                        <?= formatTarikhRingkas(
                                            $hariAvailable['tarikh']
                                        ) ?>

                                        ·

                                        <?= $hariAvailable['jumlah'] ?>
                                        staf
                            ...
                            <?php else: ?>
                                ...
                                <span class="staff-empty-note">

                                    <iconify-icon
                                        icon="mdi:calendar-remove-outline">
                                    </iconify-icon>

                                    Tiada slot WFH tersedia minggu ini.
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-4 month-nav">
        <button
