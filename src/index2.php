   ...
   <nav class="navbar navbar-expand-lg modern-topbar py-3 sticky-top">
        <div class="container-fluid px-4">
            ...
            <a class="navbar-brand fw-bold d-flex align-items-center gap-2" href="index2.php" style="color: var(--primary-blue);">
                ...
                <span class="fs-4">Meja<span class="text-dark">Bantuan</span></span>
            </a>
            ...
            <div class="collapse navbar-collapse" id="topMenu">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-1 ms-lg-5">
                    <li class="nav-item">
                        <a class="nav-link active d-flex align-items-center gap-2" href="index2.php">
					...
					<li class="nav-item">
                        <a class="nav-link d-flex align-items-center gap-2" href="meja_bantuan.php">
							...
							<div class="card browser-statistics">
								<div class="card shadow-sm border-0 rounded-4">
									...
									<div class="card-header bg-transparent border-0 pt-4 pb-0 d-flex justify-content-between align-items-center">
										<div>
											<h5 class="fw-bold mb-0 text-dark">Aduan Dijawab Harian</h5>
											<p class="text-muted small mb-0">Prestasi team pada hari ini</p>
										</div>
										<div class="center-content">
											<span class="badge bg-light text-primary border border-primary-subtle rounded-pill px-3 py-1 fw-semibold">
												Sasaran: 15 / Hari
											</span>
										</div>
									...
									<div class="card-body pt-4">
										...
										<div class="mb-4">
											<div class="d-flex justify-content-between align-items-center mb-2">
												<div class="d-flex align-items-center gap-3">
													...
													<div>
														<h6 class="mb-0 fw-bold text-dark">Iffa</h6>
														<span class="text-muted small fw-medium">12 / 15 Aduan</span>
													</div>
												</div>
												<div class="text-end">
													<h5 class="mb-0 text-primary fw-bolder">80%</h5>
												</div>
											</div>
											<div class="progress" style="height: 8px; border-radius: 10px; background-color: #f1f5f9;">
												<div class="progress-bar bg-primary progress-gradient-primary rounded-pill" role="progressbar" style="width: 80%" aria-valuenow="12" aria-valuemin="0" aria-valuemax="15"></div>
											</div>
										</div>
										...
										<div class="mb-4">
											<div class="d-flex justify-content-between align-items-center mb-2">
												<div class="d-flex align-items-center gap-3">
													...
													<div>
														<h6 class="mb-0 fw-bold text-dark">Fareisya</h6>
														<span class="text-muted small fw-medium">30 / 15 Aduan <span class="badge bg-success ms-1">Selesai</span></span>
													</div>
												</div>
												<div class="text-end">
													<h5 class="mb-0 text-success fw-bolder">200%</h5>
												</div>
											</div>
											<div class="progress" style="height: 8px; border-radius: 10px; background-color: #f1f5f9;">
												<div class="progress-bar bg-success progress-gradient-success rounded-pill" role="progressbar" style="width: 100%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="15"></div>
											</div>
										</div>
										...
										<div class="mb-4">
											<div class="d-flex justify-content-between align-items-center mb-2">
												<div class="d-flex align-items-center gap-3">
													<div class="bg-warning text-dark rounded-circle d-flex align-items-center justify-content-center fw-bold shadow-sm" style="width: 40px; height: 40px;">
														YA
													</div>
													<div>
														<h6 class="mb-0 fw-bold text-dark">Yaana</h6>
														<span class="text-muted small fw-medium">9 / 15 Aduan</span>
													</div>
												</div>
												<div class="text-end">
													<h5 class="mb-0 text-warning fw-bolder">60%</h5>
												</div>
											</div>
											<div class="progress" style="height: 8px; border-radius: 10px; background-color: #f1f5f9;">
												<div class="progress-bar bg-warning progress-gradient-warning rounded-pill" role="progressbar" style="width: 60%" aria-valuenow="9" aria-valuemin="0" aria-valuemax="15"></div>
											</div>
										</div>
										...
										<div class="mb-4">
											<div class="d-flex justify-content-between align-items-center mb-2">
												<div class="d-flex align-items-center gap-3">
													...
													<div>
														<h6 class="mb-0 fw-bold text-dark">Hafiz</h6>
														<span class="text-muted small fw-medium">6 / 15 Aduan</span>
													</div>
												</div>
												<div class="text-end">
													<h5 class="mb-0 text-info fw-bolder">40%</h5>
												</div>
											</div>
											<div class="progress" style="height: 8px; border-radius: 10px; background-color: #f1f5f9;">
												<div class="progress-bar bg-info progress-gradient-info rounded-pill" role="progressbar" style="width: 40%" aria-valuenow="6" aria-valuemin="0" aria-valuemax="15"></div>
											</div>
										</div>

										<div class="text-center mt-4">
											<a class="btn btn-light text-primary fw-semibold rounded-pill px-4" href="aduan_harian.php">Lihat Laporan Penuh</a>
										</div>
